...
public class LoveViewActivity extends FragmentActivity {
    @Override
    ...
    private class SvgImagesAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            return new CustomShapeSquareImageView(mContext, R.mipmap.cgx, CustomShapeImageView.Shape.SVG, getItem(i));// It is just a sample ;)
        }
