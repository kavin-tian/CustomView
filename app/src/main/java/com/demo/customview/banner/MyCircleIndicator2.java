...
/**
 * 在 CircleIndicator绑定viewpage 基础上修改
 * CircleIndicator2 绑定Banner轮播图
 */
public class MyCircleIndicator2 extends View {
    ...
    public MyCircleIndicator2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MyCircleIndicator2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorRadius = typedArray.getDimensionPixelSize(R.styleable.MyCircleIndicator_ci_radius, DEFAULT_INDICATOR_RADIUS);
        mIndicatorMargin = typedArray.getDimensionPixelSize(R.styleable.MyCircleIndicator_ci_margin, DEFAULT_INDICATOR_MARGIN);
        mIndicatorBackground = typedArray.getColor(R.styleable.MyCircleIndicator_ci_background, DEFAULT_INDICATOR_BACKGROUND);
        mIndicatorSelectedBackground = typedArray.getColor(R.styleable.MyCircleIndicator_ci_selected_background, DEFAULT_INDICATOR_SELECTED_BACKGROUND);
        int gravity = typedArray.getInt(R.styleable.MyCircleIndicator_ci_gravity, DEFAULT_INDICATOR_LAYOUT_GRAVITY);
        mIndicatorLayoutGravity = Gravity.values()[gravity];
        int mode = typedArray.getInt(R.styleable.MyCircleIndicator_ci_mode, DEFAULT_INDICATOR_MODE);
    ...
    private void trigger(int position, float positionOffset) {
        MyCircleIndicator2.this.mCurItemPosition = position;
        MyCircleIndicator2.this.mCurItemPositionOffset = positionOffset;
