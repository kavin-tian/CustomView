...
/**
 * https://blog.csdn.net/jky_yihuangxing/article/details/52190999
 */
public class MyCircleIndicator extends View {
    ...
    private void trigger(int position, float positionOffset) {
        MyCircleIndicator.this.mCurItemPosition = position;
        MyCircleIndicator.this.mCurItemPositionOffset = positionOffset;
